...
func _setup_managers() -> void:
	...
	# Registrar managers en GameManager singleton
	GameManager.register_managers(
		generator_manager,
		production_manager,
		sales_manager,
		customer_manager,
...
func _setup_ui_system() -> void:
	...
	generation_panel = tab_navigator.get_node(
		"MainContainer/ContentContainer/GenerationPanel"
	).get_child(0)
	production_panel = tab_navigator.get_node(
		"MainContainer/ContentContainer/ProductionPanel"
	).get_child(0)
	sales_panel = tab_navigator.get_node("MainContainer/ContentContainer/SalesPanel").get_child(0)
	customers_panel = tab_navigator.get_node(
		"MainContainer/ContentContainer/CustomersPanel"
	).get_child(0)
