...
class Achievement:
	...
	func _init(p_id: String, p_category: AchievementCategory, p_title: String,
			   p_description: String, p_icon: String, p_required: float,
			   p_gems: int = 0, p_tokens: int = 0, p_multiplier: float = 1.0,
			   p_hidden: bool = false):
		id = p_id
		category = p_category
		title = p_title
