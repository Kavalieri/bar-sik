...
enum AchievementCategory {PRODUCTION, ECONOMIC, META, AUTOMATION, PROGRESSION, SPECIAL, COLLECTION}  # Cerveza producida  # Dinero y ganancias  # Prestige y estrellas  # Sistemas automáticos  # Niveles y upgrades  # Eventos especiales  # Meta-achievements
...
class Achievement:
	...
	func _init(
		p_id: String,
		p_category: AchievementCategory,
		p_title: String,
...
func _create_production_achievements():
	achievements["first_batch"] = Achievement.new(
		...
		"Primera Tanda",
		"Produce tu primera cerveza",
		"res://gfx/achievements/beer_icon.png",
		1,
		5,
		0
	)
	...
	achievements["hundred_beers"] = Achievement.new(
		...
		AchievementCategory.PRODUCTION,
		"Producción Básica",
		"Produce 100 cervezas",
		"res://gfx/achievements/brewery_icon.png",
		100,
		10,
		1
	)
	...
	achievements["thousand_beers"] = Achievement.new(
		...
		AchievementCategory.PRODUCTION,
		"Mil Cervezas",
		"Produce 1,000 cervezas",
		"res://gfx/achievements/factory_icon.png",
		1000,
		25,
		2
	)
	...
	achievements["mass_production"] = Achievement.new(
		...
		AchievementCategory.PRODUCTION,
		"Producción Masiva",
		"Produce 10,000 cervezas",
		"res://gfx/achievements/industry_icon.png",
		10000,
		50,
		5,
		1.1
	...
	achievements["industrial"] = Achievement.new(
		...
		AchievementCategory.PRODUCTION,
		"Era Industrial",
		"Produce 100,000 cervezas",
		"res://gfx/achievements/industrial_icon.png",
		100000,
		100,
		10,
		1.2
	...
	achievements["mega_brewery"] = Achievement.new(
		...
		AchievementCategory.PRODUCTION,
		"Mega Cervecería",
		"Produce 1,000,000 de cervezas",
		"res://gfx/achievements/mega_icon.png",
		1000000,
		250,
		25,
		1.5
	...
	achievements["beer_empire"] = Achievement.new(
		...
		AchievementCategory.PRODUCTION,
		"Imperio Cervecero",
		"Produce 10,000,000 de cervezas",
		"res://gfx/achievements/empire_icon.png",
		10000000,
		500,
		50,
		2.0
...
func _create_economic_achievements():
	achievements["first_sale"] = Achievement.new(
		...
		"res://gfx/achievements/sale_icon.png",
		1,
		5,
		0
	)
	...
	achievements["small_business"] = Achievement.new(
		...
		"Pequeño Negocio",
		"Gana $1,000",
		"res://gfx/achievements/business_icon.png",
		1000,
		10,
		1
	)
	...
	achievements["successful_bar"] = Achievement.new(
		...
		"Bar Exitoso",
		"Gana $100,000",
		"res://gfx/achievements/success_icon.png",
		100000,
		25,
		2
	)
	...
	achievements["millionaire"] = Achievement.new(
		...
		"Millonario",
		"Gana $1,000,000",
		"res://gfx/achievements/million_icon.png",
		1000000,
		50,
		5,
		1.1
	...
	achievements["multi_millionaire"] = Achievement.new(
		...
		"Multimillonario",
		"Gana $10,000,000",
		"res://gfx/achievements/multi_million_icon.png",
		10000000,
		100,
		10,
		1.2
	...
	achievements["billionaire"] = Achievement.new(
		...
		"Billonario",
		"Gana $1,000,000,000",
		"res://gfx/achievements/billion_icon.png",
		1000000000,
		250,
		25,
		1.5
	...
	achievements["token_starter"] = Achievement.new(
		...
		AchievementCategory.ECONOMIC,
		"Primer Token",
		"Gana tu primer token de prestige",
		"res://gfx/achievements/token_icon.png",
		1,
		0,
		10
	)
	...
	achievements["token_collector"] = Achievement.new(
		...
		"Coleccionista",
		"Acumula 100 tokens",
		"res://gfx/achievements/collector_icon.png",
		100,
		25,
		50,
		1.1
...
func _create_meta_achievements():
	achievements["first_prestige"] = Achievement.new(
		...
		"Primer Prestige",
		"Realiza tu primer prestige",
		"res://gfx/achievements/prestige_icon.png",
		1,
		0,
		25,
		1.1
	...
	achievements["veteran"] = Achievement.new(
		...
		AchievementCategory.META,
		"Veterano",
		"Realiza 10 prestiges",
		"res://gfx/achievements/veteran_icon.png",
		10,
		50,
		100,
		1.2
	...
	achievements["master"] = Achievement.new(
		...
		AchievementCategory.META,
		"Maestro",
		"Realiza 50 prestiges",
		"res://gfx/achievements/master_icon.png",
		50,
		150,
		250,
		1.5
	...
	achievements["legend"] = Achievement.new(
		...
		AchievementCategory.META,
		"Leyenda",
		"Realiza 100 prestiges",
		"res://gfx/achievements/legend_icon.png",
		100,
		300,
		500,
		2.0
	...
	achievements["star_gazer"] = Achievement.new(
		...
		"Gana 50 estrellas totales",
		"res://gfx/achievements/star_icon.png",
		50,
		25,
		50
	)
...
func _create_automation_achievements():
	achievements["auto_pilot"] = Achievement.new(
		...
		"Piloto Automático",
		"Usa automatización por 5 minutos",
		"res://gfx/achievements/auto_icon.png",
		300,
		15,
		5
	)
	...
	achievements["automation_master"] = Achievement.new(
		...
		"Usa automatización por 1 hora",
		"res://gfx/achievements/automation_icon.png",
		3600,
		50,
		20,
		1.1
	...
	achievements["ai_overlord"] = Achievement.new(
		...
		AchievementCategory.AUTOMATION,
		"Señor de la IA",
		"Usa automatización por 10 horas totales",
		"res://gfx/achievements/ai_icon.png",
		36000,
		150,
		75,
		1.3
	...
	achievements["efficiency_expert"] = Achievement.new(
		...
		"Alcanza 95% de eficiencia automática",
		"res://gfx/achievements/efficiency_icon.png",
		95,
		100,
		50,
		1.2
...
func _create_progression_achievements():
	achievements["dedicated_player"] = Achievement.new(
		...
		"Jugador Dedicado",
		"Juega por 10 sesiones",
		"res://gfx/achievements/dedication_icon.png",
		10,
		25,
		10
	)
	...
	achievements["bar_veteran"] = Achievement.new(
		...
		AchievementCategory.PROGRESSION,
		"Veterano del Bar",
		"Juega por 100 horas totales",
		"res://gfx/achievements/time_icon.png",
		360000,
		100,
		50,
		1.2
	...
	achievements["lifetime_dedication"] = Achievement.new(
		...
		"Juega por 1000 horas totales",
		"res://gfx/achievements/lifetime_icon.png",
		3600000,
		500,
		250,
		2.0,
...
func _create_special_achievements():
	achievements["early_bird"] = Achievement.new(
		...
		"Madrugador",
		"Juega antes de las 6 AM",
		"res://gfx/achievements/early_icon.png",
		1,
		10,
		5
	)
	...
	achievements["night_owl"] = Achievement.new(
		...
		AchievementCategory.SPECIAL,
		"Ave Nocturna",
		"Juega después de las 11 PM",
		"res://gfx/achievements/night_icon.png",
		1,
		10,
		5
	)
	...
	achievements["weekend_warrior"] = Achievement.new(
		...
		"Juega en fin de semana",
		"res://gfx/achievements/weekend_icon.png",
		1,
		15,
		5
	)
	...
	achievements["perfectionist"] = Achievement.new(
		...
		AchievementCategory.SPECIAL,
		"Perfeccionista",
		"Completa una sesión sin errores",
		"res://gfx/achievements/perfect_icon.png",
		1,
		50,
		20,
		1.1,
	...
	achievements["speed_demon"] = Achievement.new(
		...
		"Alcanza el primer prestige en menos de 1 hora",
		"res://gfx/achievements/speed_icon.png",
		1,
		75,
		25,
		1.2,
...
func _create_collection_achievements():
	achievements["achievement_hunter"] = Achievement.new(
		...
		"Cazador de Logros",
		"Desbloquea 10 achievements",
		"res://gfx/achievements/hunter_icon.png",
		10,
		50,
		25
	)
	...
	achievements["completionist"] = Achievement.new(
		...
		AchievementCategory.COLLECTION,
		"Completista",
		"Desbloquea 25 achievements",
		"res://gfx/achievements/complete_icon.png",
		25,
		150,
		75,
		1.3
	...
	achievements["achievement_master"] = Achievement.new(
		...
		"res://gfx/achievements/master_all_icon.png",
		30,
		500,
		200,
		3.0,
...
func _update_progress_tracking():
	...
	if (
		automation_manager
		and automation_manager.has_method("is_active")
		and automation_manager.is_active
	):
