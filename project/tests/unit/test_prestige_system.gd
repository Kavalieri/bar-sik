...
func test_bonus_application(prestige_manager: PrestigeManager, game_data: GameData):
	...
	var income_mult = game_data.get("prestige_income_multiplier") if game_data.has("prestige_income_multiplier") else 1.0
	var speed_mult = game_data.get("prestige_speed_multiplier") if game_data.has("prestige_speed_multiplier") else 1.0
	var token_mult = game_data.get("prestige_customer_token_multiplier") if game_data.has("prestige_customer_token_multiplier") else 1.0
