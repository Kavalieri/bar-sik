...
func test_prestige_requirement_calculation():
	...
	assert_almost_eq(actual_requirement, expected_requirement, 1.0, "Requerimiento de prestigio incorrecto")
...
func test_prestige_stars_calculation():
	...
	var actual_stars = _calculate_prestige_stars(money_at_prestige, prestige_requirement, efficiency_bonus)
...
func test_offline_progress_calculation():
	...
	var actual_progress = _calculate_offline_progress(offline_seconds, production_per_second, offline_efficiency)
...
func test_offline_progress_caps():
	...
	assert_le(effective_offline_seconds, max_offline_seconds, "Tiempo offline excede el máximo")
