...
func _test_memory_management():
	...
	var initial_memory = OS.get_static_memory_usage_by_type().get("Object", 0)
	...
	var peak_memory = OS.get_static_memory_usage_by_type().get("Object", 0)
	...
	var final_memory = OS.get_static_memory_usage_by_type().get("Object", 0)
